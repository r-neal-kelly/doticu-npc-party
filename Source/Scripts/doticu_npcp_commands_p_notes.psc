...
function Member(int code_return, string str_name)
    ...
    elseIf code_return == doticu_npcp_codes.ACTOR()
        LOGS.Create_Note("That can't become a member.")
    elseIf code_return == doticu_npcp_codes.MEMBER()
        LOGS.Create_Note(str_name + " is already a member.")
    elseIf code_return == doticu_npcp_codes.MEMBERS()
    ...
    elseIf code_return == doticu_npcp_codes.DEAD()
        LOGS.Create_Note(str_name + " can't be revived, and so can't become a member.")
    elseIf code_return == doticu_npcp_codes.CLONE()
...
function Unmember(int code_return, string str_name)
    ...
    elseIf code_return == doticu_npcp_codes.MEMBER()
        LOGS.Create_Note(str_name + " isnt a member.")
    elseIf code_return == doticu_npcp_codes.CLONE()
        LOGS.Create_Note(str_name + " isnt a clone.")
    else
...
function Resurrect(int code_return, string str_name)
    ...
    elseIf code_return == doticu_npcp_codes.IS()
...
function Reanimate(int code_return, string str_name)
    ...
    elseIf code_return == doticu_npcp_codes.ALIVE()
...
function Mannequinize(int code_return, string str_name)
    ...
    elseIf code_return == doticu_npcp_codes.MARKER()
...
function Unmannequinize(int code_return, string str_name)
    ...
    elseIf code_return == doticu_npcp_codes.IS()
        LOGS.Create_Note(str_name + " is not a mannequin.")
    else
...
function Settle(int code_return, string str_name)
    ...
    elseIf code_return == doticu_npcp_codes.IS()
        LOGS.Create_Note(str_name + " is already settled.")
    else
...
function Unsettle(int code_return, string str_name)
    ...
    elseIf code_return == doticu_npcp_codes.IS()
        LOGS.Create_Note(str_name + " is already unsettled.")
    else
...
function Resettle(int code_return, string str_name)
    ...
    elseIf code_return == doticu_npcp_codes.ISNT()
...
function Enthrall(int code_return, string str_name)
    ...
    elseIf code_return == doticu_npcp_codes.VAMPIRE()
...
function Unparalyze(int code_return, string str_name)
    ...
    elseIf code_return == doticu_npcp_codes.IS()
        LOGS.Create_Note(str_name + " is already unparalyzed.")
    else
...
function Stylize(int code_return, string str_name, int code_style)
    ...
    elseIf code_return == doticu_npcp_codes.ISNT()
        LOGS.Create_Note("That isn't a valid style.")
    else
...
function Vitalize(int code_return, string str_name, int code_vitality)
    ...
    elseIf code_return == doticu_npcp_codes.ISNT()
        LOGS.Create_Note("That isn't a valid vitality.")
    else
...
function Follow(int code_return, string str_name)
    ...
    elseIf code_return == doticu_npcp_codes.FOLLOWER()
        LOGS.Create_Note(str_name + " is already following.")
    elseIf code_return == doticu_npcp_codes.MANNEQUIN()
...
function Unsneak(int code_return, string str_name)
    ...
    elseIf code_return == doticu_npcp_codes.IS()
        LOGS.Create_Note(str_name + " is not sneaking.")
    else
...
function Unsaddle(int code_return, string str_name)
    ...
    elseIf code_return == doticu_npcp_codes.IS()
        LOGS.Create_Note(str_name + " is not saddled.")
    else
...
function Move(int code_return, string str_name)
    if code_return == doticu_npcp_codes.IS()
    ...
    elseIf code_return == doticu_npcp_codes.DISPLAY()
...
function Members_Display_Stop(int code_return)
    ...
    elseIf code_return == doticu_npcp_codes.DISPLAY()
        LOGS.Create_Note("Display has already been stopped.")
    else
...
function Followers_Unsettle(int code_return)
    ...
    elseIf code_return == doticu_npcp_codes.HASNT()
        LOGS.Create_Note("All followers are already unsettled.")
    else
