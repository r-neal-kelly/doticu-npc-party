Scriptname doticu_npc_party_script_logs extends Quest
...
; Public Methods
function Create_Note(string str_note, bool do_log = true); do_write (to disk)
...
function Create_Error(string str_error, bool do_log = true); do_write (to disk)
