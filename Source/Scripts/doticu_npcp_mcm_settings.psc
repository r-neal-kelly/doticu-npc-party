...
auto state p_STATE_SETTINGS
    function f_Build_Page()
        ...
        MCM.AddEmptyOption()
        p_option_key_fs_summon_all = MCM.AddKeymapOption(" Followers: Summon All ", VARS.key_fs_summon_all, MCM.OPTION_FLAG_WITH_UNMAP)
        p_option_key_fs_summon_mobile = MCM.AddKeymapOption(" Followers: Summon Mobile ", VARS.key_fs_summon_mobile, MCM.OPTION_FLAG_WITH_UNMAP)
        p_option_key_fs_summon_immobile = MCM.AddKeymapOption(" Followers: Summon Immobile ", VARS.key_fs_summon_immobile, MCM.OPTION_FLAG_WITH_UNMAP)
        p_option_key_fs_settle = MCM.AddKeymapOption(" Followers: Settle ", VARS.key_fs_settle, MCM.OPTION_FLAG_WITH_UNMAP)
        p_option_key_fs_unsettle = MCM.AddKeymapOption(" Followers: Unsettle ", VARS.key_fs_unsettle, MCM.OPTION_FLAG_WITH_UNMAP)
        p_option_key_fs_immobilize = MCM.AddKeymapOption(" Followers: Immobilize ", VARS.key_fs_immobilize, MCM.OPTION_FLAG_WITH_UNMAP)
        p_option_key_fs_mobilize = MCM.AddKeymapOption(" Followers: Mobilize ", VARS.key_fs_mobilize, MCM.OPTION_FLAG_WITH_UNMAP)
        p_option_key_fs_sneak = MCM.AddKeymapOption(" Followers: Sneak ", VARS.key_fs_sneak, MCM.OPTION_FLAG_WITH_UNMAP)
        p_option_key_fs_unsneak = MCM.AddKeymapOption(" Followers: Unsneak ", VARS.key_fs_unsneak, MCM.OPTION_FLAG_WITH_UNMAP)
        p_option_key_fs_resurrect = MCM.AddKeymapOption(" Followers: Resurrect ", VARS.key_fs_resurrect, MCM.OPTION_FLAG_WITH_UNMAP)
        MCM.AddEmptyOption()
        MCM.AddEmptyOption()

        MCM.AddHeaderOption(" Hotkeys for One Follower/Member ")
        MCM.AddEmptyOption()
        p_option_key_m_toggle_paralyzed = MCM.AddKeymapOption(" Member: Toggle Paralyzed ", VARS.key_toggle_paralyzed, MCM.OPTION_FLAG_WITH_UNMAP)
        MCM.AddEmptyOption()
        MCM.AddEmptyOption()
        MCM.AddEmptyOption()
    endFunction
