...
namespace doticu_skylib {
    ...
    template <>
    class none<doticu_npcp::Expoee_ID_t> :
        public none_numeric<doticu_npcp::Expoee_ID_t>
    {
    public:
    ...
    template <>
    class maybe<doticu_npcp::Expoee_ID_t> :
        public maybe_numeric<doticu_npcp::Expoee_ID_t>
    {
    public:
    ...
    template <>
    class some<doticu_npcp::Expoee_ID_t> :
        public some_numeric<doticu_npcp::Expoee_ID_t>
    {
    public:
