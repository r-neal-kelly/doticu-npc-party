...
namespace doticu_skylib { namespace doticu_npcp {
    ...
    public:
        ...
        using Index_e   = Settler_Value_Index_Sandboxer_e;
    ...
    public:
        ...
        Settler_Sandboxer_t(Settler_Sandboxer_t&& other) noexcept = delete;
        Settler_Sandboxer_t& operator =(const Settler_Sandboxer_t& other) = delete;
        Settler_Sandboxer_t& operator =(Settler_Sandboxer_t&& other) noexcept = delete;

    public:
        virtual         ~Settler_Sandboxer_t();
    ...
    public:
        ...
        Bool_t              Unlock_On_Arrival();
        void                Unlock_On_Arrival(Bool_t value);
