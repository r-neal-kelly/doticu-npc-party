...
namespace doticu_npcp { namespace Party {
    ...
    class Member_Flags_Only_Playables_e_data :
    ...
    class Member_Flags_Only_Playables_e :
        public Enum_t<Word_t>
    {
    public:
        enum enum_type : value_type
        {
            ...
            SKYLIB_DEFINE_FLAG(Member_Flags_Only_Playables_e_data, FOLLOWER),
            SKYLIB_DEFINE_FLAG(Member_Flags_Only_Playables_e_data, GUARD),
            SKYLIB_DEFINE_FLAG(Member_Flags_Only_Playables_e_data, HOME),
            ...
            SKYLIB_DEFINE_FLAG(Member_Flags_Only_Playables_e_data, SETTLEMENT),
