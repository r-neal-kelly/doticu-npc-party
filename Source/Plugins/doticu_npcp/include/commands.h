...
namespace doticu_npcp { namespace Modules { namespace Control {
    ...
    public:
        ...
        void Mobilize(Actor_t* actor, Bool_t do_notify_success);
        void Immobilize(Actor_t* actor, Bool_t do_notify_success);
        void Settle(Actor_t* actor, Bool_t do_notify_success);
        void Resettle(Actor_t* actor, Bool_t do_notify_success);
        void Unsettle(Actor_t* actor, Bool_t do_notify_success);
        void Enthrall(Actor_t* actor);
        void Unthrall(Actor_t* actor);
        void Paralyze(Actor_t* actor, Bool_t do_notify_success);
        void Unparalyze(Actor_t* actor, Bool_t do_notify_success);
        ...
        void Stylize_Default(Actor_t* actor, Bool_t do_notify_success);
        void Stylize_Warrior(Actor_t* actor, Bool_t do_notify_success);
        void Stylize_Mage(Actor_t* actor, Bool_t do_notify_success);
        void Stylize_Archer(Actor_t* actor, Bool_t do_notify_success);
        void Stylize_Coward(Actor_t* actor, Bool_t do_notify_success);
        void Vitalize_Mortal(Actor_t* actor, Bool_t do_notify_success);
        void Vitalize_Protected(Actor_t* actor, Bool_t do_notify_success);
        void Vitalize_Essential(Actor_t* actor, Bool_t do_notify_success);
        void Vitalize_Invulnerable(Actor_t* actor, Bool_t do_notify_success);
        ...
        void Rate(Actor_t* actor, Int_t rating, Bool_t do_notify_success);
        ...
        void Cycle_Style(Actor_t* actor, Bool_t do_notify_success);
        void Cycle_Vitality(Actor_t* actor, Bool_t do_notify_success);
        void Cycle_Rating(Actor_t* actor, Bool_t do_notify_success);
