...
namespace doticu_npcp { namespace Actor2 { namespace Exports {
    ...
    void Refresh_Outfit(StaticFunctionTag *, Actor *ref_actor, TESObjectREFR *ref_outfit, TESObjectREFR *ref_outfit2, TESForm *ref_linchpin, TESObjectREFR *ref_removals);
    void Refresh_Outfit_Dead(StaticFunctionTag *, Actor *ref_actor, TESObjectREFR *ref_outfit, TESObjectREFR *ref_outfit2, TESForm *ref_linchpin, TESObjectREFR *ref_removals);
