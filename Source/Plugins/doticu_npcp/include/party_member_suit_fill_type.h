...
namespace doticu_skylib {
    ...
    template <>
    class none<doticu_npcp::Party::Member_Suit_Fill_Type_e> :
        public none_enum<doticu_npcp::Party::Member_Suit_Fill_Type_e>
    {
    public:
    ...
    template <>
    class maybe<doticu_npcp::Party::Member_Suit_Fill_Type_e> :
        public maybe_enum<doticu_npcp::Party::Member_Suit_Fill_Type_e>
    {
    public:
    ...
    template <>
    class some<doticu_npcp::Party::Member_Suit_Fill_Type_e> :
        public some_enum<doticu_npcp::Party::Member_Suit_Fill_Type_e>
    {
    public:
