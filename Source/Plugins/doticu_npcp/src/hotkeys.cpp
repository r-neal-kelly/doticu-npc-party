...
namespace doticu_skylib { namespace doticu_npcp {
    ...
    Hotkeys_t::Save_t::Save_t() :
        global_dialogue_menu{ 0 },

        actor_toggle_member{ 0 },
        actor_toggle_move{ 0 },
        actor_move_nearer{ 0 },
        actor_move_farther{ 0 },
        actor_move_rotate_left{ 0 },
        actor_move_rotate_right{ 0 },
        actor_has_base{ 0 },
        actor_count_base{ 0 },
        actor_has_head{ 0 },
        actor_count_heads{ 0 },

        member_toggle_clone{ 0 },
        member_toggle_settler{ 0 },
        member_toggle_thrall{ 0 },
        member_toggle_immobile{ 0 },
        member_toggle_paralyzed{ 0 },
        member_toggle_follower{ 0 },

        follower_toggle_sneak{ 0 },
        follower_toggle_saddler{ 0 },

        members_toggle_display{ 0 },
        members_display_previous{ 0 },
        members_display_next{ 0 },

        followers_summon_all{ 0 },
        followers_summon_mobile{ 0 },
        followers_summon_immobile{ 0 },
        followers_settle{ 0 },
        followers_unsettle{ 0 },
        followers_mobilize{ 0 },
        followers_immobilize{ 0 },
        followers_sneak{ 0 },
        followers_unsneak{ 0 },
        followers_saddle{ 0 },
        followers_unsaddle{ 0 },
        followers_resurrect{ 0 }
    {
    }
